package com.adds.userInterface.customViews.DSFab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = DSFabUtils.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = DSFabUtils.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = DSFabUtils.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = DSFabUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = DSFabUtils.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = DSFabUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = DSFabUtils.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = DSFabUtils.dpToPx(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = DSFabUtils.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = DSFabUtils.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = DSFabUtils.dpToPx(getContext(), mMenuShadowYOffset);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            DSLabel label = (DSLabel) child.getTag(R.id.fab_label);
            if (label != null) {
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        final DSLabel label = new DSLabel(mLabelsContext);
    ...
    private void setLabelEllipsize(DSLabel label) {
                ...
                if (child instanceof FloatingActionButton && child.getVisibility() != GONE) {
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            DSLabel label = (DSLabel) fab.getTag(R.id.fab_label);
