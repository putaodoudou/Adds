...
public class DSCryptographyHelper {
     ...
     * @param context
     */
    public static String decryptUserDatas(String credential, Context context) throws UnrecoverableKeyException, CertificateException, NoSuchAlgorithmException,
